...
1. Du behöver en gruppvariabel och en kontinuerlig variabel för varje mättillfälle. Kontrollera att skalnivåerna är valda^[Val av skalnivåer demonstreras i avsnitt \@ref(skalnivåer)] så att gruppvariabeln är markerad med <img src="images/icons/nominal.JPG" width="3%" alt=" grouped data icon"/> och alla kontinuerliga variabler är markerade med <img src="images/icons/continuous.JPG" width="3%" alt=" ikonen för kontinuerliga data"/>.  
